...
from snp_encodings import discard_het, encode_het
...
markersA, markersB, markersAB, ref, loci = load_data("data/markers_1.txt",
                                                     "data/markers_4.txt",
                                                     "data/markers_41.txt",
                                                     "data/reference.txt")
...
test_data  = create_test_data_heterokaryotic(markersAB, discard_het, encode_het, loci, ref) 
